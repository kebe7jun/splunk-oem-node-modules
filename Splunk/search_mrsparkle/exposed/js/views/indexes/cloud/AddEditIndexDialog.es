...
import '../shared/AddEditIndexDialog.pcss';
...
export default Modal.extend({
    ...
    initialize(options = {}) {
        ...
        this.maxArchiveRetentionDays = Math.floor(this.model.stateModel.get('maxArchiveRetention') / (3600 * 24));
        ...
        if (options.isNew) {   // new mode
            ...
            const maxIndexSizeObject = this.isArchiverAppInstalled ?
                this.formatSize(this.model.entity.entry.content.get('maxGlobalDataSizeMB')) :
    ...
    showSelectedStorageView() {
        switch (this.model.stateModel.get('dynamicStorageOption')) {
