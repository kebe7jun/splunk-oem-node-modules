...
define(
    ...
    function (
        ...
        return BaseView.extend({
            ...
            \
            <td class="cell-type"><%- model.entry.content.get("type") %></td>\
            <td class="cell-realname"><%- model.entry.content.get("realname") %></td>\
            <td class="cell-email"><%- model.entry.content.get("email") %></td>\
            <td class="cell-tz"><%- model.entry.content.get("tz") %></td>\
            <td class="cell-defaultApp"><%- model.entry.content.get("defaultApp") %></td>\
            <td class="cell-defaultAppSourceRole"><%- model.entry.content.get("defaultAppSourceRole") %></td>\
