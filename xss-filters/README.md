...
Simply download the latest minified version from the [`dist/`](./dist) folder OR from the <a href="https://cdn.jsdelivr.net/gh/yahoo/xss-filters@master/dist/xss-filters.js">CDN</a>. Embed it in your HTML file, and all filters are available in a global object called `xssFilters`.
